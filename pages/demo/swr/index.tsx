...
const SWRLab = (props: Props) => {
  ...
  if (error) return <Layout>Failed to Load Page</Layout>;

  return (
    <Layout>
      <h1>SWR</h1>
      {data.map((p) => (
        <div className="w-full max-w-sm px-4 py-3 mb-3 mx-auto bg-white rounded-md shadow-md dark:bg-gray-800">
